        ...
        <div class="row">
            ...
            <div class="col-12 col-xl-4">
                <div class="card h-100">
                    ...
                    <div class="card-body p-3">
                        <p class="text-sm">
                            Hi, I’m {{ Auth::user()->name }}, Decisions: If you can’t decide, the answer is no. If two
                            equally
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Email:</strong>
                                &nbsp; {{ Auth::user()->email }}</li>
                            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Kelas:</strong>
                                &nbsp; {{ Auth::user()->kelas }}
                            </li>
                            <li class="list-group-item border-0 ps-0 pb-0">
                                <strong class="text-dark text-sm">Social:</strong> &nbsp;
                                <a class="btn btn-github btn-simple mb-0 ps-1 pe-2 py-0" href="javascript:;">
