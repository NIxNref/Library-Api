<!-- Modal -->
<div class="modal fade" id="editSiswa_{{ $admin->id }}" tabindex="-1" role="dialog" aria-labelledby="editSiswaLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered position-relative" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editSiswaLabel">Edit Admin</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('siswa.edit', ['id' => $admin->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <input type="hidden" id="editBookId" value="{{ $admin->id }}">
                    <div class="modal-body container-fluid">
                        <div class="mb-3">
                            ...
                            <input autocomplete="off" type="text"
                                ...
                                name="role_status" value="{{ old('role_status', $admin->role_status) }}">
                            @error('role_status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
